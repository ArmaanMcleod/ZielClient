...
public class VideoActivity extends AppCompatActivity {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    switch (item.getItemId()) {
      case R.id.menu_settings:
        startActivity(new Intent(this, com.quartz.zielclient.activities.common.util.SettingsActivity.class));
        return true;
  ...
  protected  void onResume() {
     ...
     */
    audioCodec = getAudioCodecPreference(com.quartz.zielclient.activities.common.util.SettingsActivity.PREF_AUDIO_CODEC,
            com.quartz.zielclient.activities.common.util.SettingsActivity.PREF_AUDIO_CODEC_DEFAULT);
    videoCodec = getVideoCodecPreference(com.quartz.zielclient.activities.common.util.SettingsActivity.PREF_VIDEO_CODEC,
  ...
  private VideoCodec getVideoCodecPreference(String key, String defaultValue) {
    ...
    switch (videoCodecName) {
      case Vp8Codec.NAME:
        boolean simulcast = preferences.getBoolean(com.quartz.zielclient.activities.common.util.SettingsActivity.PREF_VP8_SIMULCAST,
                com.quartz.zielclient.activities.common.util.SettingsActivity.PREF_VP8_SIMULCAST_DEFAULT);
  ...
  private EncodingParameters getEncodingParameters() {
    final int maxAudioBitrate = Integer.parseInt(
            preferences.getString(com.quartz.zielclient.activities.common.util.SettingsActivity.PREF_SENDER_MAX_AUDIO_BITRATE,
                    com.quartz.zielclient.activities.common.util.SettingsActivity.PREF_SENDER_MAX_AUDIO_BITRATE_DEFAULT));
    final int maxVideoBitrate = Integer.parseInt(
            preferences.getString(com.quartz.zielclient.activities.common.util.SettingsActivity.PREF_SENDER_MAX_VIDEO_BITRATE,
