      ...
      Voice.handleMessage(
          ...
          new MessageListener() {
            ...
            public void onCallInvite(CallInvite callInvite) {
              ...
              VoiceFirebaseMessagingService.this.sendCallInviteToActivity(
                  callInvite, notificationId);
            }
  ...
  private void notify(CallInvite callInvite, int notificationId) {
    ...
    if (callInvite.getState() == CallInvite.State.PENDING) {
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        NotificationChannel callInviteChannel =
            new NotificationChannel(
                VOICE_CHANNEL, "Primary Voice Channel", NotificationManager.IMPORTANCE_DEFAULT);
